    ...
    <div class="main-content">
        ...
        if (isset($_GET['id']) && is_numeric($_GET['id'])) {
            ...
            if ($result->num_rows > 0) {
                ...
                echo '<a href="recipes.php" class="back-button"><i class="fas fa-arrow-left"></i> Back to Recipes</a>';
                ...
                echo '<button class="action-btn"><i class="far fa-heart"></i> Save Recipe</button>';
